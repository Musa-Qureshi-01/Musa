              ...
              <div className="relative z-50" ref={dropdownRef}>
                ...
                {isCVOpen && (
                  <motion.div
                    ...
                    className="absolute top-[calc(100%+0.6rem)] left-1/2 -translate-x-1/2 lg:left-0 lg:-translate-x-0 w-56 bg-[#0d1117] border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-[100]"
                  >
